...
public class UserDbStorage implements UserStorage {
    ...
    public List<User> getUsersList() {
        ...
        for (User user : users) {
            user.setFriendsId(friendsMap.getOrDefault(user.getId(), Set.of()));
        }
    ...
    public User findById(Long id) {
        ...
        user.setFriendsId(getUserFriends(user.getId()));
        return user;
    }
    ...
    public List<User> getAllUsers() {
        ...
        for (User user : users) {
            user.setFriendsId(allFriends.getOrDefault(user.getId(), new HashSet<>()));
        }
